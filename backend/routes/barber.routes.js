...
router.post("/", requireAuth, requireRole("receptionist"), upload.any(), validateFileType, handleMulterErrors, BarberController.create);
router.put("/:id", requireAuth, property("receptionist"), upload.any(), validateFileType, handleMulterErrors, BarberController.update);
