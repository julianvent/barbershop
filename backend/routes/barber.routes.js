...
router.post('/', requireAuth, requireRole("receptionist"), uploadBarberImage.any(), BarberController.create);
router.put('/:id', requireAuth, property("receptionist"), uploadBarberImage.any(), BarberController.update);
