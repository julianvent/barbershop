...
router.get("/:id", requireAuth, requireRole("receptionist"), isBarberInEstablishment("receptionist"), barberOutput(), BarberController.getById);
...
router.put("/:id", requireAuth, requireRole("receptionist"), isBarberInEstablishment("receptionist"), uploadBarberImage.any(), validateFileType, handleMulterErrors, BarberController.update);
router.delete("/:id", requireAuth, requireRole("receptionist"), isBarberInEstablishment("receptionist"), BarberController.delete);
